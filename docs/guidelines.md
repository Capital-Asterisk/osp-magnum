...
Balance spacing around parentheses. Spaces after an opening brace should match its corresponding closing brace. Spaces are not always required around braces; just do whatever seems most readable:
